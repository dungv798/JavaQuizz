...
<html xmlns="" xml:lang="en" lang="en">
    ...
    <script type="text/javascript">
        tumblr_custom_tracking_url  = '/verify/wwfsbdd';
        var _gaq = _gaq || [];
        _gaq.push(['_setAccount', 'UA-97144-8']);
        _gaq.push(['_setAllowLinker', true]);
        _gaq.push(['_setDomainName', 'tumblr.com']);
                    _gaq.push(['_trackPageview', '/verify/wwfsbdd']);
            ...
            <tr>
                <td align="center" valign="middle">
                    <h1 class="callout_row header" id="l10n_title">
                        <span class="callout_title">Welcome to Online Exam Portal</span>
                    </h1>

                    <div class="callout_row callout_row_text">
                        Online Secured Platform To Create, Deliver, Manage and Assess Tests, From Anywhere Anytime. Create,<br> Deliver, Manage & Assess MCQs,
                        Entrance Exam, Mock Tests, etc.. </div>

                    <div class="callout_row app_buttons">
                      <a href="index.jsp" class="download_ios chrome blue">
                            
                        Home</a>
                        <a href="login.jsp" class="download_android chrome green">
                            
                        Login   </a>
                        <a href="contactuspage.html" class="download_windows chrome purple last">
